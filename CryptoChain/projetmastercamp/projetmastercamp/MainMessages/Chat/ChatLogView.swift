...
//    func toString() -> String!
    ...
    func handleSend(){
        //print(key)
        let message = chatText.data(using: .utf8)!
...
//        print(message)
        ...
        let messageData = [FirebaseConstants.fromId: fromId, FirebaseConstants.toId: toId, FirebaseConstants.text: self.chatText
...
//            print("Recipient saved message r")
        ...
        func persistRecentMessage(){
            ...
            let data = [
                ...
                FirebaseConstants.text: self.sealedBox,
 ...
 //           }, label: {
  ...
  //          }))
    ...
    private var chatBottomBar: some View{
        HStack(spacing: 16){
            NavigationLink{
                Text("Devrait pouvoir échanger nos NFT")
            }label:{
